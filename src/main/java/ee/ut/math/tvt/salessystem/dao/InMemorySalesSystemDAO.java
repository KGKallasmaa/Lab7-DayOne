...
public class InMemorySalesSystemDAO implements SalesSystemDAO {
    ...
    public List<StockItem> findStockItems() {
        ...
        StockItem stockitem_2 = new StockItem(1L,"Test2","I'm cool",440,1220);
        StockItem stockitem_3 = new StockItem(1L,"Test3","I'm cool",540,1230);
        StockItem stockitem_4 = new StockItem(1L,"Test4","I'm cool",640,1240);
        StockItem stockitem_5 = new StockItem(1L,"Test5","I'm cool",740,1250);
        StockItem stockitem_6 = new StockItem(1L,"Test6","I'm cool",840,1260);
        StockItem stockitem_7 = new StockItem(1L,"Test7","I'm cool",940,1270);
        StockItem stockitem_8 = new StockItem(1L,"Test8","I'm cool",240,1280);
        StockItem stockitem_9 = new StockItem(1L,"Test9","I'm cool",140,1290);
        StockItem stockitem_10 = new StockItem(1L,"Test10","I'm cool",40,1300);
    ...
    public HashMap<Long,List<SoldItem>> findAllOrders(){
        ...
        StockItem stockitem_1_1 = new StockItem(1L,"Test 1","Order 1",340,120);
        StockItem stockitem_1_2 = new StockItem(1L,"Test 1","Order 1",340,120);
        //Order 2
        StockItem stockitem_2_0 = new StockItem(1L,"Test 2","Order 2",350,150);
        StockItem stockitem_2_1 = new StockItem(1L,"Test 2","Order 2",350,180);
        StockItem stockitem_2_2 = new StockItem(1L,"Test 2","Order 2",350,190);
        //Order 3
        StockItem stockitem_3_0 = new StockItem(1L,"Test 3","Order 3",360,140);
        StockItem stockitem_3_1 = new StockItem(1L,"Test 3","Order 3",380,130);
